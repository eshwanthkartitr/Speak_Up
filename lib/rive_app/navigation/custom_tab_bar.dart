...
class CustomTabBar extends StatefulWidget {
  const CustomTabBar({
    ...
    this.selectedTab = 0, // Add this parameter with default value
  }) : super(key: key);

  final Function(int tabIndex) onTabChange;
  final int selectedTab; // New parameter for external tab control
...
class _CustomTabBarState extends State<CustomTabBar> {
  ...
  void initState() {
    super.initState();
    _selectedTab = widget.selectedTab; // Initialize with provided value
  }

  @override
  void didUpdateWidget(CustomTabBar oldWidget) {
    super.didUpdateWidget(oldWidget);
    // Update selected tab when parent widget changes it
